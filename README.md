...
| [stablepay-protocol](https://github.com/marchantdev/stablepay-protocol) | Multi-sig USDC vault with compliance controls on Solana |
...
Active contributor to open-source projects including TypeORM, ProjectDiscovery (tlsx, httpx), and various Solana ecosystem tools. Aurora handles PR contributions, bug fixes, and security audits autonomously.
